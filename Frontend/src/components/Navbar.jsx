...
const Navbar = () => { 
   ...
   useEffect(()=>{
    ...
    const navItems = (
        <> 
      <li className='hover:bg-blue-100'><a href="/">Home</a></li>
      <li className='hover:bg-blue-100'><a href="/Course">Course</a></li>
      <li className='hover:bg-blue-100'><a href="/ContactUs">Contact</a></li>
      <li className='hover:bg-blue-100'><a href="/AboutUs">About</a></li>
        </>
    );
  return (
   <>
   ...
   ${sticky?"sticky-navbar shadow-md bg-base-100 dark:bg-slate-900 dark:text-white duration-300 transition-all ease-in-out": ""}`}
   >
  ...
  <div className="navbar-start">
    ...
    <img src={book}  className="w-8 h-8 md:w-11 md:h-11" alt="" /> <a className="text-2xl text-blue-600 font-bold cursor-pointer flex">Book Store</a>
  </div>
 ...
 <div>
    <a className="bg-blue-600 text-white px-3 py-2 rounded-md hover:bg-blue-800 duration-300 cursor-pointer" 
    onClick={() => 
